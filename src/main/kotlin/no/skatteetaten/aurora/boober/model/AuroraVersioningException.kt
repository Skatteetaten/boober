...
class AuroraVersioningException(auroraConfig: AuroraConfig, currentFile: AuroraConfigFile, previousVersion: String)
    : PreconditionFailureException("The provided version of the current file ($previousVersion) in AuroraConfig ${auroraConfig.affiliation} is not correct (${currentFile.version})") {
