...
class AuroraDeploymentConfigMapperV1 : AuroraDeploymentConfigMapper {
    ...
    override val extractors = listOf(
            ...
            AuroraConfigFieldHandler("affiliation", validator = { it.pattern("Affiliation is must be alphanumeric and under 24 characters", "^[a-z]{0,23}[a-z]$") }),
            ...
            AuroraConfigFieldHandler("envName", validator = { it.length(50, "ArtifactId must be set and be shorter then 50 characters") }),
