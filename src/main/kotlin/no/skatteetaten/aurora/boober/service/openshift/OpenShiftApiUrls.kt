...
class OpenShiftApiUrls(
    ...
    companion object Factory {
        ...
        fun getCollectionPathForResource(baseUrl: String, kind: String, namespace: String? = null): String {
            ...
            val apiType = if (endpointKey in listOf("namespace", "services", "configmaps", "secrets", "replicationcontrollers", "persistentvolumeclaims", "pods")) "api" else "oapi"
            val namespacePrefix = if (endpointKey !in listOf("namespace", "projects", "projectrequests", "buildrequests", "deploymentreqeusts", "users", "groups")) {
