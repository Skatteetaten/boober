...
class AuroraConfigService(
    ...
    fun saveFile(newFile: AuroraConfigFile, auroraConfig: AuroraConfig, ref: AuroraConfigRef): AuroraConfig {
        ...
        val (_, invalid) = auroraDeploymentContextService.createValidatedAuroraDeploymentContexts(
        ...
        try {
            ...
            throw AuroraConfigServiceException(
                "Could not save changes in AuroraConfig underlying message=${e.localizedMessage}",
                e
            )
        }
        repo.close()
