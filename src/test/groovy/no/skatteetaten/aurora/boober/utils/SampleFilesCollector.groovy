...
class SampleFilesCollector {
  ...
  static Map<String, JsonNode> getSampleFiles(DeployCommand aid) {
  ...
  static Map<String, JsonNode> getQaEbsUsersSampleFiles() {
    return collectFilesToMapOfJsonNode("about.json", "${APP_NAME}.json", "${ENV_NAME}/about.json",
        "${ENV_NAME}/${APP_NAME}.json")
  }
