...
class OpenShiftClientTest extends AbstractSpec {
  ...
  def "Creates OpenShiftGroup indexes"() {
    ...
    given:
      ...
      serviceAccountClient.get("/oapi/v1/groups/", _, _) >>
          new ResponseEntity(new ObjectMapper().readValue(response, JsonNode), OK)
      serviceAccountClient.get("/oapi/v1/users", _, _) >>
    ...
    then:
      ...
      openShiftGroups.groupUsers['APP_PaaS_drift'] ==
          ['k2222222', 'k1111111', 'k3333333', 'k4444444', 'y5555555', 'm6666666', 'm7777777', 'y8888888', 'y9999999']
  ...
  def "UrlEncode label selectors"() {
    ...
    expect:
      OpenShiftClient.urlEncode(queryParam) ==
          "labelSelector=app%3D$name%2CbooberDeployId%2CbooberDeployId%21%3D$deployId"
  }
