...
class OpenShiftObjectGeneratorTest : AbstractOpenShiftObjectGeneratorTest2() {
    ...
    fun `should create openshift objects`(test: OpenShiftObjectCreationTestData) {
        ...
        val deploymentSpec =
            AuroraDeploymentSpecService.createAuroraDeploymentSpecInternal(auroraConfig, aid, test.overrides)
    ...
    fun `generate rolebinding should include serviceaccount `() {
        ...
        val deploymentSpec = AuroraDeploymentSpecService.createAuroraDeploymentSpecInternal(auroraConfig, aid)
